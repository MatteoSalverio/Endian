...
import { threeToCannon } from "https://unpkg.com/three-to-cannon@4.3.0/dist/three-to-cannon.esm.js";
...
class player extends obj {
    ...
    update() {
        ...
        //playerGroup.quaternion.y = this.camera.quaternion.y;
    }
}
...
scene.add(light);
const dLight = new THREE.DirectionalLight(0xeeeeff, 8);
